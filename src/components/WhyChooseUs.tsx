...
const WhyChooseUs = () => {
  ...
  return (
    <section id="about" className="py-20 bg-navy text-secondary-foreground relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-secondary-foreground/80 mb-8 text-xl">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {reasons.map((reason, index) => (
                <div key={index} className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-heading text-3xl mb-1">{reason.title}</h4>
                    <p className="text-secondary-foreground/70 text-xl">{reason.description}</p>
                  </div>
                </div>
              ))}
            </div>
